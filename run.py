...
navbar = dbc.NavbarSimple(
    brand='Predicting Return on Investment for Lending Club Loans',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Nick Flannery', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:nickf.flannery@gmail.com', style={'color':'black'}), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Nckflannery/lending-club-predictions', style={'color':'brown'}), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/nick-flannery-40a140194/', style={'color':'#0077B5'}), 
                ], 
                className='lead'
            )
        )
